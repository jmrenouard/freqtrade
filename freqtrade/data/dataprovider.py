...
class DataProvider:
    ...
    def _add_external_df(
        ...
        _last_analyzed = last_analyzed or datetime.now(timezone.utc)
    ...
    def get_producer_df(
        ...
        """
        _timeframe = timeframe or self._default_timeframe
        _candle_type = candle_type or self._default_candle_type
